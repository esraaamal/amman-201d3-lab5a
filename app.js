...
Write a function called sum() that takes in two numbers as arguments and then returns
 an array where the first element is the sum of those numbers, and the second element is
  a concatenated string that EXACTLY follows this example and uses the values that were input into the function:
...
// Once you get the test passing, do an a-c-p cycle and synchronize the code between GitHub and your laptop. Don't
...
function multiply(a, b) { //eslint-disable-line
  var multProduct = a*b ;
  var msg2 = 'The product of 5 and 9 is 45.'; 

return[multProduct ,msg2];
}
...
var sum3 =a +b +c ;
var multiProduct = a*b*c ;
var msga ='4 and 7 and 5 sum to 16.';
var msgb ='The product of 4 and 7 and 5 is 140.';

return[sum3,multiProduct,msga,msgb];
}
...
function. To do addition, use your sum() function that you've already created.
...
you think it is finished, uncomment the call for the testSumArray() function and see if the test passes.*/
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(var j = 0;j < testDynamicArray.length ;  j++) {
    mulProd2= multiply(mulProd2[0],testDynamicArray[j]) ;}
    var msg6 = 'The numbers 1,2,3,4,5 have a product of 120.';
    return[mulProd2[0] , msg6];
}
